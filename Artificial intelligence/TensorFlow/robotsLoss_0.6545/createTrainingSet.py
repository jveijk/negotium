...
def createSet(number, filename):
    ...
    for i in range(number):
        boxBoard, startX, startY, goalX, goalY, program = createBoardAndProgram(BOARD_SIZE_X, BOARD_SIZE_Y, NO_OF_BOXES, LENGTH_OF_PROGRAM)
...
sess = tf.Session()
createSet(TRAINING_SET, "./records/training_set.tfrecord")
createSet(TEST_SET, "./records/test_set.tfrecord")
sess.close()
